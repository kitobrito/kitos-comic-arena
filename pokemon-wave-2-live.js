(function (root, factory) {
    ...
    return [
        ...
        character('zapdos','Zapdos','Controller','zapdos','fp.png','A legendary electric controller that punishes harmful skills and detonates Thunderbolt into Zap Cannon.',[
            ...
            skill('zapdos-flight','Flight','zapdos','flight.webp','For 2 turns, Zapdos is invulnerable to non-affliction enemy skills and Thunderstorm triggers deal 10 instead of 5.', ['Random'],4,'self',['Physical','Instant'],[status('zapdos_flight',2,'self',{invulnerableToNonAffliction:true,zapdosThunderboltDamage:10})])
        ]),
