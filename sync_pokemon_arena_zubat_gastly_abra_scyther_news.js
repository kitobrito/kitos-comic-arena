...
const newsPost = {
    ...
    blocks: [
        ...
        {
            type: 'paragraph',
            text: 'Scyther has arrived as the first Pokemon mission character, and the mission is intentionally rank 6, grindy, and worth working toward. The Scyther Trial is joined by Gastly\'s Haunted Tower mission, also rank 6, so Pokemon Arena finally has a proper early progression ladder to chase.',
        },
        {
            type: 'paragraph',
    ...
    paragraphs: [
        ...
        'Scyther has arrived as the first Pokemon mission character, and the mission is intentionally rank 6, grindy, and worth working toward. The Scyther Trial is joined by Gastly\'s Haunted Tower mission, also rank 6, so Pokemon Arena finally has a proper early progression ladder to chase.',
    ...
    changes: [
        ...
        skillShowcase('scyther', 'scyther-fury-cutter', 'Fury Cutter permanently gains damage every time it is used, which makes the mission reward feel worth the grind.'),
...
const gastlyMission = {
    ...
    requirements: ['A grindy early Pokemon mission that asks for patience before it pays out.'],
    goals: [
