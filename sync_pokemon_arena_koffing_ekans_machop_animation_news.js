...
const newsPost = {
    ...
    blocks: [
        ...
        {
            type: 'paragraph',
            text: 'This update also carries a much heavier Pokemon Arena economy pass. Most active skills now cost meaningfully more energy so teams cannot snowball from bargain turns all match long, while a small number of signature tempo moves like Ember, Thundershock, Gust, and Lick stay cheap so a few characters still keep that fast opener identity.',
        },
        {
            type: 'paragraph',
            text: 'Several battle rules were tightened up too. Koffing now evolves after using 4 unique skills, every evolution heals 10 HP when it happens, Toxic now deals its first poison tick immediately, and Smog now deals damage right away and keeps ticking every turn because it is an instant skill that cannot be interrupted out of its damage cycle.',
        },
    ],
    paragraphs: [
        ...
        'This update also carries a much heavier Pokemon Arena economy pass. Most active skills now cost meaningfully more energy so teams cannot snowball from bargain turns all match long, while a small number of signature tempo moves like Ember, Thundershock, Gust, and Lick stay cheap so a few characters still keep that fast opener identity.',
        'Several battle rules were tightened up too. Koffing now evolves after using 4 unique skills, every evolution heals 10 HP when it happens, Toxic now deals its first poison tick immediately, and Smog now deals damage right away and keeps ticking every turn because it is an instant skill that cannot be interrupted out of its damage cycle.',
    ],
    changes: [
        ...
        skillShowcase('koffing', 'koffing-passive-evolution-weezing', 'Koffing now evolves after 4 unique skill uses instead of racing into Weezing too early, and the evolution now also restores 10 HP when it triggers.', 'update'),
        ...
        sectionNote('Economy', 'Pokemon Arena active-skill costs were rebalanced upward across the roster so teams build toward stronger turns instead of ending matches with giant unused energy pools.', 'quality'),
        sectionNote('Tempo', 'A few signature openers still stay cheap on purpose, including Ember, Thundershock, Gust, and Lick, so some characters keep a real low-cost identity.', 'quality'),
        sectionNote('Combat Rules', 'Toxic now deals damage immediately on application, Smog now deals damage on the first turn and every following turn as an instant effect, and all evolutions now heal 10 HP when they trigger.', 'quality'),
    ],
    author: 'kito',
    createdAt: now,
    updatedAt: now,
