...
const newsPost = {
    ...
    changes: [
        ...
        skillShowcase('superman', 'superman-passive-the-man-of-steel', 'Passive The Man of Steel now grants 8 unpierceable damage reduction instead of 12, including after Solar Flare reactivates it.'),
        ...
        skillShowcase('the-green-goblin', 'the-green-goblin-passive-mad-bomber', 'Passive Mad Bomber now has a 25% chance to plant a Bomb whenever Green Goblin uses a skill.'),
        skillShowcase('rick-grimes', 'rick-grimes-357-revolver', '.357 Revolver now has no cost and uses a 70% hit chance with a 30% miss chance.'),
        skillShowcase('rick-grimes', 'rick-grimes-throat-slit', 'Throat Slit now deals 20 piercing damage, applies 5 bleed damage next turn, silences harmful skills for 1 turn, and executes at 15 HP or below from either hit.'),
    ],
    author: 'kito',
    createdAt: now,
    updatedAt: now,
