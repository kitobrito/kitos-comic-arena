...
const skillsByType = {
    ...
    Psychic: [
        ...
        'mr-mime-forcefield', 'mr-mime-light-screen',
...
const POKEMON_STATUS_TOOLTIPS = Object.freeze({
    ...
    zapdos_zap_cannon: { tooltipTextTemplate: 'When this countdown expires, this character takes {onExpireDamage} plus {zapCannonBonus} bonus piercing damage and is stunned. Thunderstorm triggers shorten the countdown and add damage.' },
    zapdos_flight: { tooltipTextTemplate: 'Zapdos is invulnerable to non-affliction enemy skills, and Thunderstorm triggers deal {zapdosThunderboltDamage} damage.' },
